...
local function get_workspace()
	-- USERPROFILE for windows, HOME for linux
	...
	local settings = {
		java = {
			...
			format = {
				...
				settings = {
					url = "C:\\Users\\crme107\\AppData\\Local\\nvim\\format-styles\\eclipse-java-format.xml",
					profile = "Default",
				},
			},
			...
			configuration = {
				-- Use this for smaller projects to have more control
				-- updateBuildConfiguration = "interactive",
				-- Use this for bigger multi-module projects to keep everything in sync automatically
